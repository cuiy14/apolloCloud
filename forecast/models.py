...
class Upload(models.Model):
    ...
    # blank & default is to remove the '---' in the model form;
    # the fist parameter is for the label of the form
    forecastperiod = models.CharField("Forecasting period", max_length=1, \
                                      choices=FORECASTPERIOD, blank=False,
                                      default='m')
    forecastmethod = models.CharField("Forecasting method", max_length=3, \
